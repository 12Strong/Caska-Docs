...
<Callout kind="info">
  Admins **cannot access**: Communication settings, Data management, Team
  settings, or Cost Calculator settings. These are Owner-only.
</Callout>
...
- Can view orders
- Can view batches
- Can view inventory and add stock
- Can view products
- Cannot see other employees' timesheet data

<Callout kind="info">
  Employees **cannot access**: Customers, Reports, Follow-Up, or most Settings
  areas.
</Callout>
